...
def test_function_arbitrary_arguments():
    ...
    # (*name must occur before **name) For example, if we define parameter list.

    def test_function(first_param, *arguments):
        """This function accepts it's arguments through "arguments" tuple and keyword dictionary."""
